    ...
    */
    public String dispatch(String request)
    {
        ...
        try {
            ...
            System.out.println("json Param: " + jsonParam.toString());
            int j = 0;
            for (Map.Entry<String, JsonElement>  entry  :  jsonParam.entrySet())
            {
        		System.out.println("param in loop: " + entry.getValue().getAsString());
            ...
            for (int i=0; i<types.length; i++)
            {
            	...
            	System.out.println("In first switch: " + strParam[i]);
            	System.out.println("Switch type: " + types[i].getCanonicalName());
        ...
        System.out.println(jsonReturn.toString() + "JsonReturn");
        return jsonReturn.toString();
    }
